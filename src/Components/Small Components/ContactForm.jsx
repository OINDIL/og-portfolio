        ...
        <div>
            <form ref={form} onSubmit={sendEmail} className='flex flex-col font-inter sm:w-1/2 w-full text-gray-400 gap-2'>
                ...
                <motion.input
                    ...
                    transition={{ duration: 1 }}
                    viewport={{ once: true }}
                    type="text" name="user_name" className='outline-none bg-inherit border-b' required />
                <motion.label
                    initial={{ x: -80, opacity: 0 }}
                    whileInView={{ x: 0, opacity: 1 }}
                    transition={{ duration: 1 }}
                ...
                <motion.input
                    ...
                    transition={{ duration: 1 }}
                    viewport={{ once: true }}
                    type="email" name="user_email" className='outline-none bg-inherit border-b' required />
                <motion.label
                    initial={{ x: -80, opacity: 0 }}
                    whileInView={{ x: 0, opacity: 1 }}
                    transition={{ duration: 1 }}
                ...
                <motion.textarea
                    ...
                    transition={{ duration: 1 }}
                    viewport={{ once: true }}
                    name="message" className='outline-none bg-inherit border-b' />
                <center>
