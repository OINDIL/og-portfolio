        ...
        <div>
            <motion.div
                ...
                <div className="flex sm:flex-row flex-col gap-5">
                    <img className='rounded-xl border' src="https://placehold.co/200x270" alt="something" height={270} width={200} />
                    <div className="flex flex-col sm:w-1/2 w-auto gap-1">
                        ...
                        <motion.button
                            ...
                            whileTap={{ scale: 0.9 }}
                            className={`sm:w-40 w-auto font-medium flex justify-center gap-2 py-2 px-3 border rounded-3xl bg-gray-300 text-gray-500 transition ease-linear duration-100`} disabled> Private Github
                        </motion.button>
                    </div>
                </div>
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <article>
                        ...
                        <ul className='text-gray-600'>
                            ...
                            <li>
                                <p><span className='font-bold'>Advanced Search and Filtering:</span> The platform offers robust search and filtering capabilities, allowing users to narrow down their channel exploration based on specific criteria such as topic, genre, language, and audience demographics.</p>
                            </li>
                            <li>
                                <p><span className='font-bold'>Real-time Analytics for Creators:</span> YTCrawler provides content creators with actionable insights and analytics, including audience demographics, engagement metrics, and performance trends. This data empowers creators to optimize their content strategy and enhance viewer engagement.</p>
                            </li>
                            <li>
